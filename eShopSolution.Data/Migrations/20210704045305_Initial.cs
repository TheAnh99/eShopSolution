        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    OrderDate = table.Column<DateTime>(nullable: false, defaultValue: new DateTime(2021, 7, 4, 11, 53, 4, 827, DateTimeKind.Local).AddTicks(341)),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SeoAlias = table.Column<string>(maxLength: 200, nullable: false),
                    LanguageId = table.Column<string>(unicode: false, maxLength: 5, nullable: false),
                    ProductTranslationId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductTranslations_ProductTranslations_ProductTranslationId",
                        column: x => x.ProductTranslationId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductTranslations_ProductTranslationId",
                table: "ProductTranslations",
                column: "ProductTranslationId");
        }
